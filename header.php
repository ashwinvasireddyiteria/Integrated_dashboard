...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg">
       <div class="container-fluid">
          ...
          <a class="navbar-brand" href="./"><img src="images/IteriaLogo.png" alt="Logo" style="max-width: 140px;"></a>
          </div>
   ...
   <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown" style="margin-right: 50px;">
         <a class="dropdown-toggle text-dark" data-toggle="dropdown" href="#">Profile <span class="caret"></span></a>
           <ul class="dropdown-menu">
              <li style="font-size: 14px"><a href="">My Profile</a></li>
