...
if(isset($_POST['submit'])){
	...
	?>
	   <div id="box" class="font">
          ...
          <h6 class="justify-content-center" style="margin-top: 20px;">Password Reset Successful</h6>
       </div>
    <?php
       }
		else {
	...
	?>
	   <div id="box" class="font">
	      <a href="reset_password.php" onclick="pop()" class="close"><i style="solid" class="fa fa-window-close"></i></a>
...
<br><br>
  <div class="container-fluid"> 
		...
		<div class="form-group row justify-content-center">
		 <button type="submit" style="height: 41px; width: 120px; font-size: 19px" name="submit" id="submit" class="btn font-weight-bold" onclick="return validate()"><b> Submit </b></button>
		</div>
