...
$mail->Subject = 'New user registration from idea';
$mail->Body    = '<p><b>Your account has been created. Please click the below link to activate </b></p>
...
if(!$mail->send()) {
	...
	?>
	   <div id="box" class="font">
          ...
          <h6 class="justify-content-center" style="margin-top: 20px;">User created Successfuly and password mail has been sent</h6>
       </div>
    <?php
